        ...
        <div class="content-right-inner">
            <div class="form-horizontal">
                <div class="form-group">
                    <label class="col-lg-1 control-label console-color-4">教师头像:</label>
                    <div class="col-lg-2">
                ...
                <div class="form-group">
                    <label class="col-lg-1 control-label console-color-4"><span class="console-color-3">* </span>教师姓名:</label>
                ...
                <div class="form-group">
                    <label class="col-lg-1 control-label console-color-4">教师昵称:</label>
                ...
                <div class="form-group">
                    <label class="col-lg-1 control-label console-color-4"><span class="console-color-3">* </span>登录帐号:</label>
                ...
                <div class="form-group">
                    <label class="col-lg-1 control-label console-color-4"><span class="console-color-3">* </span>登录密码:</label>
                ...
                <div class="form-group">
                    <label class="col-lg-1 control-label console-color-4">个性签名:</label>
                    <div class="col-lg-4">
                        <input type="text" class="form-control" placeholder="">
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-lg-1 control-label console-color-4">毕业院校:</label>
                    <div class="col-lg-4">
                        <input type="text" class="form-control" placeholder="">
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-lg-1 control-label console-color-4">教龄:</label>
                ...
                <div class="form-group">
                    <label class="col-lg-1 control-label console-color-4"><span class="console-color-3">* </span>选择性别:</label>
                    <div class="col-lg-4">
                ...
                <div class="form-group">
                    <label class="col-lg-1 control-label console-color-4"><span class="console-color-3">* </span>是否授课:</label>
                    <div class="col-lg-4">
                        <label class="radio-inline">
                ...
                <div class="form-group">
                    <label class="col-lg-1 control-label console-color-4">教师介绍:</label>
                    <div class="col-lg-4">
                ...
                <div class="form-group">
                    <label class="col-lg-1 control-label console-color-4"></label>
                    <div class="col-lg-4">
