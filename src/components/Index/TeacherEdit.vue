<template>
    <div class="form-horizontal">
        <div class="form-group">
            <label for="" class="col-lg-1 control-label">教师头像:</label>
            <div class="col-lg-2">
                <img src="" alt="" class="img-circle" style="width: 100px;height: 100px;background: #ccc">
        ...
        <div class="form-group">
            <label for="" class="col-lg-1 control-label">*教师姓名:</label>
        ...
        <div class="form-group">
            <label for="" class="col-lg-1 control-label">教师昵称:</label>
        ...
        <div class="form-group">
            <label for="" class="col-lg-1 control-label">*登录帐号:</label>
        ...
        <div class="form-group">
            <label for="" class="col-lg-1 control-label">*登录密码:</label>
        ...
        <div class="form-group">
            <label for="" class="col-lg-1 control-label">个性签名:</label>
            <div class="col-lg-4">
                <input type="text" class="form-control" id="" placeholder="">
            </div>
        </div>
        <div class="form-group">
            <label for="" class="col-lg-1 control-label">毕业院校:</label>
            <div class="col-lg-4">
                <input type="text" class="form-control" id="" placeholder="">
            </div>
        </div>
        <div class="form-group">
            <label for="" class="col-lg-1 control-label">教龄:</label>
        ...
        <div class="form-group">
            <label for="" class="col-lg-1 control-label">*选择性别:</label>
            <div class="col-lg-4">
        ...
        <div class="form-group">
            <label for="" class="col-lg-1 control-label">*是否授课:</label>
            <div class="col-lg-4">
                <label class="radio-inline">
        ...
        <div class="form-group">
            <label for="" class="col-lg-1 control-label">教师介绍:</label>
            <div class="col-lg-4">
